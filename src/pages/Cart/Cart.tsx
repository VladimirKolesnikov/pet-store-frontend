...
const CartItemRow: React.FC<{ item: any; updateQuantityMutation: any; removeMutation: any }> = ({ item, updateQuantityMutation, removeMutation }) => {
  ...
  const isUpdating = updateQuantityMutation.isPending && updateQuantityMutation.variables?.id === item.id;
...
export const Cart: React.FC = () => {
  ...
  if (error) {
    return <div className={styles.error}>An error occurred loading your cart.</div>;
  }
